...
import com.example.modul2_kelxx.DetailActivity;
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra( "Lname", dataUser.get(viewHolder.getAdapterPosition()).getLastName());
                intent.putExtra("emaill", dataUser.get(viewHolder.getAdapterPosition()).getEmail());
                intent.putExtra("foto", dataUser.get(viewHolder.getAdapterPosition()).getAvatar());
